import{_ as s,o as n,c as a,a as l}from"./app.a12f6983.js";const h=JSON.parse('{"title":"前端部署","description":"","frontmatter":{},"headers":[{"level":3,"title":"配置前端文件","slug":"配置前端文件","link":"#配置前端文件","children":[]},{"level":3,"title":"打包","slug":"打包","link":"#打包","children":[]},{"level":3,"title":"部署","slug":"部署","link":"#部署","children":[]}],"relativePath":"guide/web.md"}'),p={name:"guide/web.md"},e=l(`<h1 id="前端部署" tabindex="-1">前端部署 <a class="header-anchor" href="#前端部署" aria-hidden="true">#</a></h1><div class="tip custom-block"><p class="custom-block-title">TIP</p><p>前端使用vue3开发，需要安装好nodejs和pnpm环境</p></div><h3 id="配置前端文件" tabindex="-1">配置前端文件 <a class="header-anchor" href="#配置前端文件" aria-hidden="true">#</a></h3><p>前端文件位于<code>client\\utils\\src\\config.ts</code>，修改<code>domain</code>为后端域名+端口，如<code>xxx.xxx.xxx.xxx:2023</code>，如果是本地部署可以使用<code>localhost:2023</code></p><h3 id="打包" tabindex="-1">打包 <a class="header-anchor" href="#打包" aria-hidden="true">#</a></h3><p>前端分为web-client、manage-client两个项目，分别对应web端、后台管理端：</p><p>先安装依赖</p><div class="language-"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki material-palenight"><code><span class="line"><span style="color:#A6ACCD;"># 进入client目录</span></span>
...
<span class="line"><span style="color:#A6ACCD;"></span></span>
<span class="line"><span style="color:#A6ACCD;">}</span></span>
<span class="line"><span style="color:#A6ACCD;"></span></span></code></pre></div>`,17),c=[e];function o(t,i,r,C,A,d){return n(),a("div",null,c)}const D=s(p,[["render",o]]);export{h as __pageData,D as default};
