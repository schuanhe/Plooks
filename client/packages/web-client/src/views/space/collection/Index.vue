...
import type { CollectionType, ModifyCollectionType } from '@plooks/apis';
import CoverUploader from "./component/CoverUploader.vue";
import { Edit, Delete } from "@plooks/icons";
import { modifyCollectionAPI, deleteCollectionAPI } from '@plooks/apis';
import {
