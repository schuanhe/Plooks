...
import { Delete } from '@plooks/icons';
import { getResourceUrl, statusCode, storageData } from '@plooks/utils';
import type { UserInfoType, CollectionInfoType, VideoType } from '@plooks/apis';
import { getCollectionInfoAPI, getCollectVideoAPI, collectAPI } from '@plooks/apis';
