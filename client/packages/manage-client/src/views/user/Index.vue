    ...
    <n-card class="card">
        ...
        <n-table class="table" striped>
            ...
            <tbody class="table-body">
                <tr :key="item.uid" v-for="item in userList">
                    <td>{{ item.uid }}</td>
                    <td>
        ...
        <n-drawer-content title="编辑信息">
            <n-form ref="formRef" :rules="rules" :model="editForm" label-width="auto">
                <n-form-item label="昵称" path="name">
                    <n-input placeholder="请输入昵称" v-model:value="editForm.nickname" />
                </n-form-item>
...
import { storageData, statusCode } from '@plooks/utils';
import { CommonAvatar, SearchBox } from '@plooks/components';
import type { UserInfoType, AdminModifyUserInfoType } from "@plooks/apis";
import {
