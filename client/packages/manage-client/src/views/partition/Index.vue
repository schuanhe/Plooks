        ...
        <div class="table-container">
            <div class="table">
                ...
                <n-table striped>
                    ...
                    <tbody class="table-body">
                        <tr :key="item.id" v-for="item in partitions">
                            <td>{{ item.id }}</td>
                            <td>{{ item.content }}</td>
                            <td class="btn-list">
            ...
            <div class="table">
                ...
                <n-table striped>
                    ...
                    <tbody class="table-body">
                        <tr :key="item.id" v-for="item in subpartition">
                            <td>{{ item.id }}</td>
                            <td>{{ item.content }}</td>
                            <td>
                                <n-button text @click="deletePartition(item.id)">删除</n-button>
...
import type { PartitionType, AddPartitionType } from '@plooks/apis';
import { getPartitionAPI, addPartitionAPI, deletePartitionAPI } from "@plooks/apis";
