    ...
    <n-card class="card">
        ...
        <n-table class="table" striped>
            ...
            <tbody class="table-body">
                <tr :key="item.vid" v-for="item in videoList">
                    <td>{{ item.vid }}</td>
                    <td>
...
import { SearchBox } from '@plooks/components';
import PartitionSelector from "./component/PartitionSelector.vue";
import type { VideoType } from "@plooks/apis";
import { adminGetVideoListAPI, adminSearchVideoAPI, adminDeleteVideoAPI } from "@plooks/apis";
