    ...
    <n-card class="card">
        ...
        <n-table striped>
            ...
            <tbody class="table-body">
                <tr :key="item.id" v-for="item in announceList">
                    <td>{{ item.id }}</td>
                    <td>{{ item.title }}</td>
                    <td>{{ item.content }}</td>
...
import type { AnnounceType } from '@plooks/apis';
import { getAnnounceAPI, addAnnounceAPI, deleteAnnounceAPI } from '@plooks/apis';
