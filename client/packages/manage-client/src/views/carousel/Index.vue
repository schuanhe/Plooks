...
import type { CarouselType, AddCarouselType } from '@plooks/apis';
import { getCarouselAPI, addCarouselAPI, deleteCarouselAPI } from '@plooks/apis';
import { getMainColor, getResourceUrl, statusCode } from '@plooks/utils';
